 ...
 * @author C0160
 */
public class AssetPositionModel extends BaseLazyModel<AssetPosition> {

    private final UserManagedBean userManagedBean;

    public AssetPositionModel(SuperEJB superEJB, UserManagedBean userManagedBean) {
        this.superEJB = superEJB;
        this.userManagedBean = userManagedBean;
    }

    @Override
    public List<AssetPosition> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
