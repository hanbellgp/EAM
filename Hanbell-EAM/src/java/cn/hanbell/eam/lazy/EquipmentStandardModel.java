 ...
 * @author C2079
 */
public class EquipmentStandardModel extends BaseLazyModel<EquipmentStandard> {

    private final UserManagedBean userManagedBean;

    public EquipmentStandardModel(SuperEJB superEJB, UserManagedBean userManagedBean) {
        this.superEJB = superEJB;
        this.userManagedBean = userManagedBean;
    }

    @Override
    public List<EquipmentStandard> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
