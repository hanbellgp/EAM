 ...
 * @author C0160
 */
public class AssetCheckModel extends BaseLazyModel<AssetCheck> {

    private final UserManagedBean userManagedBean;

    public AssetCheckModel(SuperEJB superEJB, UserManagedBean userManagedBean) {
        this.superEJB = superEJB;
        this.userManagedBean = userManagedBean;
    }

    @Override
    public List<AssetCheck> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
