 ...
 * @author C0160
 */
public class AssetAcceptanceModel extends BaseLazyModel<AssetAcceptance> {

    private final UserManagedBean userManagedBean;

    public AssetAcceptanceModel(SuperEJB superEJB, UserManagedBean userManagedBean) {
        this.superEJB = superEJB;
        this.userManagedBean = userManagedBean;
    }

    @Override
    public List<AssetAcceptance> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
