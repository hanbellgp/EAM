 ...
 * @author C2079
 */
public class EquipmentAnalyResultModel extends BaseLazyModel<EquipmentAnalyResult> {

    private final UserManagedBean userManagedBean;

    public EquipmentAnalyResultModel(SuperEJB superEJB, UserManagedBean userManagedBean) {
        this.superEJB = superEJB;
        this.userManagedBean = userManagedBean;
    }

    @Override
    public List<EquipmentAnalyResult> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
