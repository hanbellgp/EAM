...
//导出界面的EXCEL数据处理
    ...
    public void print() throws ParseException {
        ...
        fileName = "现场维修统计表" + BaseLib.formatDate("yyyyMMddHHmmss", BaseLib.getDate()) + ".xls";
    ...
    private String[] getInventoryTitle() {
        return new String[]{"资产编号", "设备名称", "所属部门", "故障发生日期", "故障现象", "维修方式", "维修人"};
    }
    ...
    private int[] getInventoryWidth() {
        return new int[]{20, 20, 20, 20, 20, 20, 20, 20};
    }
    ...
    public void query() {
        ...
        equipmentRepairsList = equipmentRepairBean.getRepairSceneStatisticslList(strdate, enddate, queryFormId, queryName);
