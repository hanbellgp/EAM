...
//导出单台设备数据
    ...
    private String[] getInventoryTitle2() {
        ...
        return new String[]{"", "", "", "", "", "", "", "", "报修时间", "维修到达时间", "维修完成时间", "维修暂停时间(分)", "因为故障造成的停工时间(分)", "维修完成时间-维修到达时间", "故障来源", "故障内容", "故障类型", "故障分类", "故障现状过程及原因", "维修作业方式", "再发防止对策", "备件费用", "人工成本", "其他费用", "总维修费用<不含人工费>", "总维修费用"};
    }
