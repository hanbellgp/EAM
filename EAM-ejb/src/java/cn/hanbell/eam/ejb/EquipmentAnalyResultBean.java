...
public class EquipmentAnalyResultBean extends SuperEJBForEAM<EquipmentAnalyResult> {
    ...
    public List<EquipmentAnalyResult> getEquipmentAnalyResultListByNativeQuery(Map<String, Object> filters, Map<String, String> orderBy) {
        ...
        sb.append("SELECT A.id,A.formid,A.formdate,A.company,A.assetno,A.assetdesc,A.spareno,A.deptno,A.deptname,A.standardlevel,A.startdate,A.enddate,A.analysisresult,B.remark,A.status,A.creator,A.credate,A.optuser,A.optdate,A.cfmuser,A.cfmdate,A.isspotcheck FROM ");
