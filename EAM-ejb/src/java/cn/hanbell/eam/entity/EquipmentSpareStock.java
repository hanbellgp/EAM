...
@NamedQueries({
    ...
    @NamedQuery(name = "EquipmentSpareStock.findBySparenumAndLocation", query = "SELECT e FROM EquipmentSpareStock e WHERE e.sparenum.sparenum = :sparenum And e.sarea = :sarea  And e.qty !=:qty  ORDER BY e.intime ASC"),
