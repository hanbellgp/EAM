...
public class AssetScrapDetail extends FormDetailEntity {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AssetScrapDetail)) {
            return false;
        }
        AssetScrapDetail other = (AssetScrapDetail) object;
    ...
    public String toString() {
        return "cn.hanbell.eam.entity.AssetScrapDetail[ id=" + id + " ]";
    }
