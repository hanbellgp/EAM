 ...
 */
@Entity
@Table(name = "assetcardspecial")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "AssetCardSpecial.getRowCount", query = "SELECT COUNT(a) FROM AssetCardSpecial a"),
    @NamedQuery(name = "AssetCardSpecial.findAll", query = "SELECT a FROM AssetCardSpecial a"),
    @NamedQuery(name = "AssetCardSpecial.findById", query = "SELECT a FROM AssetCardSpecial a WHERE a.id = :id"),
    @NamedQuery(name = "AssetCardSpecial.findByCompany", query = "SELECT a FROM AssetCardSpecial a WHERE a.company = :company"),
    @NamedQuery(name = "AssetCardSpecial.findByCompanyAndFormid", query = "SELECT a FROM AssetCardSpecial a WHERE  a.company = :company AND a.formid = :formid"),
    @NamedQuery(name = "AssetCardSpecial.findByFormid", query = "SELECT a FROM AssetCardSpecial a WHERE a.formid = :formid"),
    @NamedQuery(name = "AssetCardSpecial.findByFilters", query = "SELECT a FROM AssetCardSpecial a WHERE a.company = :company AND a.formid = :formid AND a.assetItem.itemno = :itemno AND a.deptno = :deptno AND a.userno = :userno "),
    @NamedQuery(name = "AssetCardSpecial.findByFiltersAndNotUsed", query = "SELECT a FROM AssetCardSpecial a WHERE a.srcformid = :srcformid AND a.srcseq = :srcseq AND a.used=false "),
    @NamedQuery(name = "AssetCardSpecial.findByFiltersAndUsed", query = "SELECT a FROM AssetCardSpecial a WHERE a.relformid = :relformid AND a.relseq = :relseq AND a.used=true AND a.scrap=false"),
    @NamedQuery(name = "AssetCardSpecial.findByFiltersAndScrapped", query = "SELECT a FROM AssetCardSpecial a WHERE a.relformid = :relformid AND a.relseq = :relseq AND a.used=true AND a.scrap=true"),
    @NamedQuery(name = "AssetCardSpecial.findByItemno", query = "SELECT a FROM AssetCardSpecial a WHERE a.assetItem.itemno = :itemno"),
    @NamedQuery(name = "AssetCardSpecial.findByItemnoAndNotUsed", query = "SELECT a FROM AssetCardSpecial a WHERE a.assetItem.itemno = :itemno AND a.used=false "),
    @NamedQuery(name = "AssetCardSpecial.findByDeptno", query = "SELECT a FROM AssetCardSpecial a WHERE a.deptno = :deptno"),
    @NamedQuery(name = "AssetCardSpecial.findByUserno", query = "SELECT a FROM AssetCardSpecial a WHERE a.userno = :userno"),
    @NamedQuery(name = "AssetCardSpecial.findBySrcformid", query = "SELECT a FROM AssetCardSpecial a WHERE a.srcformid = :srcformid "),
    @NamedQuery(name = "AssetCardSpecial.findByRelformidAndNeedDelete", query = "SELECT a FROM AssetCardSpecial a WHERE a.relformid = :relformid AND a.status='X' "),
    @NamedQuery(name = "AssetCardSpecial.findByWarehouseno", query = "SELECT a FROM AssetCardSpecial a WHERE a.warehouse.warehouseno = :warehouseno")})
public class AssetCardSpecial extends FormEntity {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AssetCardSpecial)) {
            return false;
        }
        AssetCardSpecial other = (AssetCardSpecial) object;
    ...
    public String toString() {
        return "cn.hanbell.eam.entity.AssetCardSpecial[ id=" + id + " ]";
    }
