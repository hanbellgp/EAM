...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "AssetDistributeDetailForQuery.findAll", query = "SELECT a FROM AssetDistributeDetailForQuery a")
    ,
    @NamedQuery(name = "AssetDistributeDetailForQuery.findById", query = "SELECT a FROM AssetDistributeDetailForQuery a WHERE a.id = :id")
    ,
    @NamedQuery(name = "AssetDistributeDetailForQuery.findByPId", query = "SELECT a FROM AssetDistributeDetailForQuery a WHERE a.assetDistribute.formid = :pid ORDER BY a.seq")})
public class AssetDistributeDetailForQuery extends BaseEntity {

    @JoinColumn(name = "pid", referencedColumnName = "formid")
    @ManyToOne(optional = false)
    private AssetDistribute assetDistribute;
    ...
    public AssetDistributeDetailForQuery() {
        this.price = BigDecimal.ZERO;
        this.amts = BigDecimal.ZERO;
    }

    /**
     * @return the assetDistribute
     */
    public AssetDistribute getAssetDistribute() {
        return assetDistribute;
    }

    /**
     * @param assetDistribute the assetDistribute to set
     */
    public void setAssetDistribute(AssetDistribute assetDistribute) {
        this.assetDistribute = assetDistribute;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AssetDistributeDetailForQuery)) {
            return false;
        }
        AssetDistributeDetailForQuery other = (AssetDistributeDetailForQuery) object;
        if (this.id != null && other.id != null) {
            return this.id.equals(other.id);
        }
        if (this.assetDistribute.getFormid() != null && other.assetDistribute.getFormid() != null) {
            return (this.assetDistribute.getFormid().equals(other.assetDistribute.getFormid()) && (this.getSeq() == other.getSeq()));
        }
